...
public class CollegeModelJDBCImpl implements CollegeModelInt  {
     ...
     * 
     */
    public long add(CollegeDTO bean) throws ApplicationException,
     ...
     * @throws DatabaseException
     */
    public void update(CollegeDTO bean) throws ApplicationException,
            DuplicateRecordException {
     ...
     * @throws DatabaseException
     */
    public List search(CollegeDTO bean, int pageNo, int pageSize)
