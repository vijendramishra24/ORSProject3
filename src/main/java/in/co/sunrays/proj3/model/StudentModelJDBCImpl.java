...
public class StudentModelJDBCImpl implements StudentModelInt {
	...
	public void update(StudentDTO bean) throws ApplicationException, DuplicateRecordException {
...
//System.out.println("check upadte 4");
	...
	public List search(StudentDTO bean, int pageNo, int pageSize) throws ApplicationException {
