			...
			<thead>
               ...
               <table class="table" >
				<tr >
					...
					<button type="submit" class="btn btn-default" name="operation" value="<%=MarksheetMeritListCtl.OP_BACK%>"> 
					Back</button>
					<%-- <button type="submit" class="btn btn-default" name="operation" value="<%=ORSView.JASPER_CTL%>"><span class="glyphicon glyphicon-print"></span> 
					Print</button> --%>
				 	<a href="<%=ORSView.JASPER_CTL%>" target="blank">click here</a>
