<%@page import="in.co.sunrays.proj3.ctl.UserRegistrationCtl"%>
...
<div class="row">
	 ...
	 <div class="col-md-6">	
			...
			<font style="color:grey; font-style: italic; font-weight: bold; font-size: 4rem;"> User Registration</font></label>
		 </div>		
		<br>
		<div align="center">
		...
		<div class="col-md-2"></div>	
						...
						<div class="col-md-4" align="left">
						<input type="text" name="dob" readonly="readonly" placeholder="Enter date of birth" class="form-control" id = "datepicker"
		...
		<div class="col-md-5 col-md-offset-1" align="center">
							...
							<button class="btn btn-default" type="submit"	name="operation" value="<%=UserRegistrationCtl.OP_SIGN_UP%>">
							<span class="glyphicon glyphicon-ok "></span> <%= UserRegistrationCtl.OP_SIGN_UP%></button>
