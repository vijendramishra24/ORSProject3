...
<%@page import="in.co.sunrays.proj3.ctl.UserCtl"%>
...
<div class="row">
	 ...
	 <div class="col-md-6">	
			...
			<label class="text-center container">
			 	<%if(bean.getId()>0){%>
        		<font style="color:grey; font-style: italic; font-weight: bold; font-size: 4rem;"> Update User </font></label>
       			<%  }else{ %>
				<font style="color:grey; font-style: italic; font-weight: bold; font-size: 4rem;"> Add User </font></label>
				<%} %>
			</div>		
		<br>
		<div align="center">
       ...
       <div class="container" align="center">
			...
			<div class="col-md-2"></div>	
						<div class="col-md-4 " align="left">
						<label style="color: grey; font-size: 18; font-weight: normal;">Login id<font color="red">*</font></label>
						</div>
						<div class="col-md-4" align="left">
		...
		<div id="secondmidpart" style="margin-top: 20px">
	 	...
	 	<div class="col-md-2"></div>	
						<div class="col-md-4" align="left">
						<label style="color: grey; font-size: 18; font-weight: normal;">Password<font color="red">*</font></label>
						</div>
						<div class="col-md-4" align="left">
		...
		<div class="col-md-2"></div>	
						...
						<div class="col-md-4" align="left">
						<input type="password" name="confirmPassword" placeholder="Enter confirmPassword" class="form-control" 
...
<div id="secondmidpart" style="margin-top: 20px">
		...
		<div class="col-md-2"></div>	
						<div class="col-md-4 " align="left">
						<label style="color: grey; font-size: 18; font-weight: normal;">Role<font color="red">*</font></label>
						</div>
						<div class="col-md-4" align="left">
						<%=HTMLUtility.getList("roleId",String.valueOf(bean.getRoleId()), l)%>
						<label class="control-label text-danger"><%=ServletUtility.getErrorMessage("roleId", request)%></label>
						</div>
		</div>
		</div>
		...
		<div class="col-md-6 col-md-offset-1" align="center">
							<%if(bean.getId()>0){%> 
							<button class="btn btn-default" type="submit"	name="operation" value="<%=UserCtl.OP_SAVE%>">
							<span class="glyphicon glyphicon-ok "></span> <%=UserCtl.OP_UPDATE%></button>   
							<%  }else{ %>
							<button class="btn btn-default" type="submit"	name="operation" value="<%=UserCtl.OP_SAVE%>">
							<span class="glyphicon glyphicon-ok "></span> <%=UserCtl.OP_SAVE%></button>
							<%} %>
													
							<button class="btn btn-default" type="submit"	name="operation" value="<%=UserCtl.OP_CANCEL%>">
							<span class="glyphicon glyphicon-cancel "></span> <%=UserCtl.OP_CANCEL%></button>
								
							<button class="btn btn-default" type="submit"	name="operation" value="<%=UserCtl.OP_RESET%>">
							<span class="glyphicon glyphicon-refresh "></span> <%=UserCtl.OP_RESET%></button>
