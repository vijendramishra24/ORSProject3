...
<%@page import="in.co.sunrays.proj3.ctl.StudentCtl"%>
...
<div class="row">
	 ...
	 <div class="col-md-6">	
			...
			<label class="text-center container">
			 	<%if(bean.getId()>0){%>
        		<font style="color:grey; font-style: italic; font-weight: bold; font-size: 4rem;"> Update Student </font></label>
       			<%  }else{ %>
				<font style="color:grey; font-style: italic; font-weight: bold; font-size: 4rem;"> Add Student </font></label>
				<%} %>
			</div>		
		<br>
		<div align="center">
...
<div id="secondmidpart" style="margin-top: 20px;">
		...
		<div class="col-md-6 col-md-offset-1" align="center">
							<%if(bean.getId()>0){%> 
							<button class="btn btn-default" type="submit"	name="operation" value="<%=StudentCtl.OP_SAVE%>">
							<span class="glyphicon glyphicon-ok "></span> <%=StudentCtl.OP_UPDATE%></button>   
							<%  }else{ %>
							<button class="btn btn-default" type="submit"	name="operation" value="<%=StudentCtl.OP_SAVE%>">
							<span class="glyphicon glyphicon-ok "></span> <%=StudentCtl.OP_SAVE%></button>
							<%} %>
													
							<button class="btn btn-default" type="submit"	name="operation" value="<%=StudentCtl.OP_CANCEL%>">
							<span class="glyphicon glyphicon-cancel "></span> <%=StudentCtl.OP_CANCEL%></button>
								
							<button class="btn btn-default" type="submit"	name="operation" value="<%=StudentCtl.OP_RESET%>">
							<span class="glyphicon glyphicon-refresh "></span> <%=StudentCtl.OP_RESET%></button>
